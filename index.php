...
//ambil total stock 
$get_stock = mysqli_query($conn, "select sum(stock) as jumlah from stock");
$count_stock = mysqli_fetch_array($get_stock); // menghitung jumlah kolom stock
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="register1.php">Daftar</a></li>
                    <li>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                            $ambilsemuastock = mysqli_query($conn, "select * from stock where stock < 1 ");

                            while ($fetch = mysqli_fetch_array($ambilsemuastock)) {
                                $barangnya = $fetch['namabarang'];
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <strong>Maaf Stock <?= $barangnya; ?> Habis! </strong> You should check in on some of
                                those fields below.
                            </div>
                            <?php
                            }
